...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "fs2" ,             version = "2.5.8",  org = "co.fs2", modules = "fs2-core", "fs2-io", "fs2-reactive-streams")
    ...
    .add(name = "monocle",          version = "3.0.0",  org = "com.github.julien-truffaut", "monocle-core", "monocle-generic", "monocle-macro", "monocle-state", "monocle-law")
    ...
    .add(name = "specs2",           version = "4.12.2",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
