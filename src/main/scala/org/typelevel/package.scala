...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats",             version = "2.0.0-RC3",org = typeLevelOrg, "cats-core", "cats-kernel", "cats-free", "cats-laws", "cats-macros", "cats-testkit", "alleycats-core")
    .add(name = "cats-effect",      version = "2.0.0-RC3",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
