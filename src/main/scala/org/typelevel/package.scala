...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "discipline-core",  version = "1.1.1", org = typeLevelOrg)
    ...
    .add(name = "http4s" ,          version = "0.21.8", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe")
    ...
    .add(name = "refined",          version = "0.9.17",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
