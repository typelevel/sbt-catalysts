...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "2.5.1",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "fs2" ,             version = "2.5.6",  org = "co.fs2", modules = "fs2-core", "fs2-io", "fs2-reactive-streams")
    .add(name = "http4s" ,          version = "0.21.23", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe", "http4s-twirl", "http4s-core")
    .add(name = "http4s" ,          version = "0.21.23", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe")
    .add(name = "kittens",          version = "2.3.1",  org = typeLevelOrg)
    ...
    .add(name = "refined",          version = "0.9.25",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
    ...
    .add(name = "specs2",           version = "4.11.0",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
    .add(name = "scalac"   ,        version = "2.12.13")
    .add(name = "scalac_2.13",      version = "2.13.5")
    .add(name = "scalac_2.12",      version = "2.12.13")
