...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "2.5.3",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "fs2" ,             version = "2.5.9",  org = "co.fs2", modules = "fs2-core")
    .addJVM(name = "fs2-jvm" ,   version = "2.5.9",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    .addJVM(name = "http4s" ,       version = "0.22.2", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe", "http4s-twirl", "http4s-core")
