...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "http4s" ,          version = "0.20.12", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json")
    ...
    .add(name = "specs2",           version = "4.8.0",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
