...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "2.1.1",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "specs2",           version = "4.9.1",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
