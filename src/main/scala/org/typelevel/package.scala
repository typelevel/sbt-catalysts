...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats",             version = "2.0.0-RC2",org = typeLevelOrg, "cats-core", "cats-kernel", "cats-free", "cats-laws", "cats-macros", "cats-testkit", "alleycats-core")
    .add(name = "cats-effect",      version = "2.0.0-RC2",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "http4s" ,          version = "0.20.10", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client")
