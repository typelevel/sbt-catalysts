...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "refined",          version = "0.9.13",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
    ...
    .add(name = "specs2",           version = "4.9.3",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
