...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "2.1.3",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    .add(name = "cats-mtl",         version = "0.7.1",  org = typeLevelOrg, "cats-mtl-core", "cats-mtl-laws")
    ...
    .add(name = "fs2" ,             version = "2.4.2",  org = "co.fs2", modules = "fs2-core", "fs2-io", "fs2-reactive-streams")
    .add(name = "http4s" ,          version = "0.21.4", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe")
    ...
    .add(name = "monocle",          version = "2.0.4",  org = "com.github.julien-truffaut", "monocle-core", "monocle-generic", "monocle-macro", "monocle-state", "monocle-law")
    .add(name = "newtype",          version = "0.4.4",  org = "io.estatico")
    .add(name = "refined",          version = "0.9.14",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
    .add(name = "scalacheck",       version = "1.14.3", org = "org.scalacheck")
    .add(name = "scalatest",        version = "3.1.2",  org = "org.scalatest")
