...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats",             version = "2.4.0",org = typeLevelOrg, "cats-core", "cats-kernel", "cats-free", "cats-laws", "cats-testkit", "alleycats-core")
    .add(name = "cats-effect",      version = "2.4.0",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
