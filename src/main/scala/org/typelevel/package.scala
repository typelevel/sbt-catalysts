...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "2.1.2",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "http4s" ,          version = "0.21.1", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe")
    ...
    .add(name = "specs2",           version = "4.9.2",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
