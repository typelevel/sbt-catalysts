...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats",             version = "2.6.0",org = typeLevelOrg, "cats-core", "cats-kernel", "cats-free", "cats-laws", "cats-testkit", "alleycats-core")
    .add(name = "cats-effect",      version = "2.5.0",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    .add(name = "cats-mtl",         version = "1.2.0",  org = typeLevelOrg, "cats-mtl", "cats-mtl-laws")
    ...
    .add(name = "fs2" ,             version = "2.5.5",  org = "co.fs2", modules = "fs2-core", "fs2-io", "fs2-reactive-streams")
    ...
    .add(name = "refined",          version = "0.9.24",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
    .add(name = "scalacheck",       version = "1.15.4", org = "org.scalacheck")
    .add(name = "scalatest",        version = "3.2.8",  org = "org.scalatest")
    .add(name = "scodec",           version = "1.11.7", org = "org.scodec", "scodec-core")
    .add(name = "shapeless",        version = "2.3.6",  org = "com.chuusai")
