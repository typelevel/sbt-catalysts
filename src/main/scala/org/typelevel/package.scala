...
object `package` {
  ...
  val libraries = Libraries()
    .add(name = "algebra",          version = "1.0.1",  org = typeLevelOrg, "algebra", "algebra-laws")
    ...
    .add(name = "cats",             version = "2.0.0-M4",org = typeLevelOrg, "cats-core", "cats-kernel", "cats-free", "cats-laws", "cats-macros", "cats-testkit", "alleycats-core")
    .add(name = "cats-effect",      version = "2.0.0-M4",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    .add(name = "cats-mtl",         version = "0.6.0",  org = typeLevelOrg, "cats-mtl-core", "cats-mtl-laws")
    .add(name = "cats-tagless",     version = "0.9",    org = typeLevelOrg, "cats-tagless-core", "cats-tagless-laws", "cats-tagless-macros")
    .add(name = "cats-collections", version = "0.8.0",  org = typeLevelOrg, "cats-collections-core")
    .add(name = "fs2" ,             version = "1.0.5",  org = "co.fs2", modules = "fs2-core", "fs2-io", "fs2-reactive-streams")
    .add(name = "http4s" ,          version = "0.20.6", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client")
    .add(name = "kittens",          version = "1.2.1",  org = typeLevelOrg)
    .add(name = "mouse",            version = "0.22",   org = typeLevelOrg)
    .add(name = "machinist",        version = "0.6.8",  org = typeLevelOrg)
    .add(name = "macro-compat",     version = "1.1.1",  org = typeLevelOrg)
    .add(name = "monocle",          version = "1.6.0",  org = "com.github.julien-truffaut", "monocle-core", "monocle-generic", "monocle-macro", "monocle-state", "monocle-law")
    .add(name = "refined",          version = "0.9.8",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
    .add(name = "scalacheck",       version = "1.14.0", org = "org.scalacheck")
    .add(name = "scalatest",        version = "3.1.0-SNAP13",  org = "org.scalatest")
    .add(name = "scala-newtype",    version = "0.4.3",  org = "io.estatico")
    ...
    .add(name = "specs2",           version = "4.6.0",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
