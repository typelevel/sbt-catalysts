...
object `package` {
  ...
  val libraries = Libraries()
    .add(name = "algebra",          version = "2.2.1",  org = typeLevelOrg, "algebra", "algebra-laws")
    ...
    .add(name = "fs2" ,             version = "2.5.3",  org = "co.fs2", modules = "fs2-core", "fs2-io", "fs2-reactive-streams")
    ...
    .add(name = "refined",          version = "0.9.21",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
    .add(name = "scalacheck",       version = "1.15.3", org = "org.scalacheck")
    .add(name = "scalatest",        version = "3.2.5",  org = "org.scalatest")
