...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "discipline",       version = "1.0.0", org = typeLevelOrg, "discipline-core", "discipline-scalatest")
    ...
    .add(name = "cats-effect",      version = "2.0.0-M5",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "refined",          version = "0.9.9",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
