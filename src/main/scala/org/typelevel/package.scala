...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "http4s" ,          version = "0.21.5", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe")
    ...
    .add(name = "scalatest",        version = "3.2.0",  org = "org.scalatest")
    ...
    .add(name = "specs2",           version = "4.10.0",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
