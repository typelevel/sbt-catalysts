...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats",             version = "2.0.0",org = typeLevelOrg, "cats-core", "cats-kernel", "cats-free", "cats-laws", "cats-macros", "cats-testkit", "alleycats-core")
    ...
    .add(name = "fs2" ,             version = "2.0.0",  org = "co.fs2", modules = "fs2-core", "fs2-io", "fs2-reactive-streams")
    ...
    .add(name = "specs2",           version = "4.7.1",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
    .add(name = "scalac"   ,        version = "2.12.9")
