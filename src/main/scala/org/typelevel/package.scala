...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-collections",  version = "0.7.0",  org = typeLevelOrg, "cats-collections-core")
    ...
    .add(name = "monocle",          version = "1.6.0-RC1", org = "com.github.julien-truffaut", "monocle-core", "monocle-generic", "monocle-macro", "monocle-state", "monocle-law")
