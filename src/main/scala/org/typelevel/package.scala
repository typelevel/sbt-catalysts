...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "http4s" ,          version = "0.20.11", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client")
    ...
    .add(name = "scalacheck",       version = "1.14.1", org = "org.scalacheck")
    ...
    .add(name = "scalac_2.13",      version = "2.13.1")
