...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "fs2" ,             version = "2.4.5",  org = "co.fs2", modules = "fs2-core", "fs2-io", "fs2-reactive-streams")
    .add(name = "http4s" ,          version = "0.21.11", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe")
