...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "3.3.4", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .addJVM(name = "http4s" ,       version = "0.23.8", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe", "http4s-twirl", "http4s-core")
    ...
    .add(name = "mouse",            version = "1.0.8",   org = typeLevelOrg)
    ...
    .add(name = "specs2",           version = "4.13.2",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
    .add(name = "scalac"   ,        version = "2.12.15")
    .add(name = "scalac_2.13",      version = "2.13.7")
