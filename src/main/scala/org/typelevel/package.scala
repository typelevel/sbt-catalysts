...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .addJVM(name = "fs2-jvm" ,      version = "3.1.0",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    .addJVM(name = "fs2-kafka",     version = "2.1.0",  org = "com.github.fd4s")
    .addJVM(name = "http4s" ,       version = "0.23.1", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe", "http4s-twirl", "http4s-core")
    .add(   name = "jawn",          version = "1.2.0",  org = org.typelevel.typeLevelOrg, "jawn-ast", "jawn-parser", "jawn-util")
    ...
    .addJVM(name = "macro-compat",  version = "1.1.1",  org = typeLevelOrg)
    ...
    .add(name = "specs2",           version = "4.12.4-js-ec",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
    ...
    .addScalacPlugin(name = "kind-projector", version = "0.13.2",  org = typeLevelOrg, crossVersion = CrossVersion.binary )
