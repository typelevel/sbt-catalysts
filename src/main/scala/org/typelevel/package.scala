...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "discipline-core",  version = "1.1.2", org = typeLevelOrg)
    ...
    .add(name = "cats",             version = "2.3.0",org = typeLevelOrg, "cats-core", "cats-kernel", "cats-free", "cats-laws", "cats-testkit", "alleycats-core")
    .add(name = "cats-effect",      version = "2.3.0",org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    .add(name = "cats-mtl",         version = "1.1.0",  org = typeLevelOrg, "cats-mtl", "cats-mtl-laws")
    ...
    .add(name = "fs2" ,             version = "2.4.6",  org = "co.fs2", modules = "fs2-core", "fs2-io", "fs2-reactive-streams")
    .add(name = "http4s" ,          version = "0.21.13", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe")
    .add(name = "kittens",          version = "2.2.0",  org = typeLevelOrg)
    .add(name = "mouse",            version = "0.26",   org = typeLevelOrg)
    ...
    .add(name = "refined",          version = "0.9.18",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
    .add(name = "scalacheck",       version = "1.15.1", org = "org.scalacheck")
    .add(name = "scalatest",        version = "3.2.3",  org = "org.scalatest")
