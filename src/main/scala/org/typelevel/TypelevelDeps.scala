...
object `package` {
  ...
  val libraries = Versions()
    ...
    .add(name = "cats",             version = "2.0.0-M2",  org = typeLevelOrg, "cats-core", "cats-kernel", "cats-free", "cats-laws", "cats-macros", "cats-testkit", "alleycats")
    .add(name = "cats-effect",      version = "2.0.0-M2",  org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    .add(name = "cats-mtl",         version = "0.5.0",  org = typeLevelOrg, "cats-mtl-core", "cats-mtl-laws")
    .add(name = "cats-tagless",         version = "0.5.0",  org = typeLevelOrg, "cats-tagless-core", "cats-tagless-laws", "cats-tagless-macros")
    ...
    .add(name = "discipline",       version = "0.11.2-M1",  org = typeLevelOrg)
    ...
    .add(name = "scalatest",        version = "3.1.0-SNAP10",  org = "org.scalatest")
