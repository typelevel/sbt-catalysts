...
object `package` {
  ...
  val libraries = Versions()
    ...
    .add(name = "cats",             version = "2.0.0-M1",  org = typeLevelOrg, "cats-core", "cats-kernel", "cats-free", "cats-laws", "cats-macros", "cats-testkit", "alleycats")
    .add(name = "cats-effect",      version = "1.3.0",  org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "scalatest",        version = "3.1.0-SNAP9",  org = "org.scalatest")
